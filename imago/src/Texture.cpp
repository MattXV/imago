...
Texture::Texture(const int textureHeight, const int textureWidth, Colour<unsigned char> colour)
{
	const long long int newHeight = (long long int)textureHeight;
	const long long int newWidth = (long long int)textureWidth;
	const long long int newChannels = (long long int)4;
	width = newWidth;
	height = newHeight;
